...
header:
  overlay_image: https://images.unsplash.com/photo-1528323273322-d81458248d40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080
  teaser: https://images.unsplash.com/photo-1581090700227-1e37b190418e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400
  caption: Case Study
---
...
> **Transparency Note:** This project is a **conceptual proposal**. No physical system was built, and no code was deployed. The following documentation outlines the high-level system architecture and the logic behind the proposed AI integration.

---

[View the Full Group 3 Presentation (PDF)](/assets/group-3-presentation.pdf)
...
## Disclaimer
This project was developed for a case competition. It represents an exploration of technical feasibility and business strategy. All cost estimates and technical architectures are theoretical.
